.onLoad <- function(libname, pkgname) {
  madrat::madratAttach(c(pkgname, "madrat", "magclass", "edgeTransport", "GDPuc", "mrcommons", "mrdrivers"))
  madrat::setConfig(
...
.onUnload <- function(libpath) {
  madrat::madratDetach(c(libpath, "madrat", "magclass", "edgeTransport", "GDPuc", "mrcommons", "mrdrivers"))
}
