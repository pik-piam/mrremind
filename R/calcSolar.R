...
calcSolar <- function() {
  ...
  # adding rooftop PV capacity in Japan in the respective bins

  x["JPN",,"PV"][,,"capacity"][,,"729"] <- (x["JPN",,"PV"][,,"capacity"][,,"729"]+1000 * 29)
  x["JPN",,"PV"][,,"capacity"][,,"771"] <- (x["JPN",,"PV"][,,"capacity"][,,"771"]+1000 * 53)
  x["JPN",,"PV"][,,"capacity"][,,"812"] <- (x["JPN",,"PV"][,,"capacity"][,,"812"]+1000 * 79)
  x["JPN",,"PV"][,,"capacity"][,,"854"] <- (x["JPN",,"PV"][,,"capacity"][,,"854"]+1000 * 153)
  x["JPN",,"PV"][,,"capacity"][,,"895"] <- (x["JPN",,"PV"][,,"capacity"][,,"895"]+1000 * 141)
  x["JPN",,"PV"][,,"capacity"][,,"937"] <- (x["JPN",,"PV"][,,"capacity"][,,"937"]+1000 * 87)
  x["JPN",,"PV"][,,"capacity"][,,"979"] <- (x["JPN",,"PV"][,,"capacity"][,,"979"]+1000 * 14)

  # adding respective area increases for rooftop PV in Japan in the respective bins, using the luse value for Japan of 92

  x["JPN",,"PV"][,,"area"][,,"729"] <- (x["JPN",,"PV"][,,"area"][,,"729"]+1000 / 92 * 29)
  x["JPN",,"PV"][,,"area"][,,"771"] <- (x["JPN",,"PV"][,,"area"][,,"771"]+1000 / 92 * 53)
  x["JPN",,"PV"][,,"area"][,,"812"] <- (x["JPN",,"PV"][,,"area"][,,"812"]+1000 / 92 * 79)
  x["JPN",,"PV"][,,"area"][,,"854"] <- (x["JPN",,"PV"][,,"area"][,,"854"]+1000 / 92 * 153)
  x["JPN",,"PV"][,,"area"][,,"895"] <- (x["JPN",,"PV"][,,"area"][,,"895"]+1000 / 92 * 141)
  x["JPN",,"PV"][,,"area"][,,"937"] <- (x["JPN",,"PV"][,,"area"][,,"937"]+1000 / 92 * 87)
  x["JPN",,"PV"][,,"area"][,,"979"] <- (x["JPN",,"PV"][,,"area"][,,"979"]+1000 / 92 * 14)

  # adding rooftop PV capacity in IND in the respective bins

  x["JPN",,"IND"][,,"capacity"][,,"895"]  <- (x["IND",,"PV"][,,"capacity"][,,"895"]  + 1000 * 30  )
  x["JPN",,"IND"][,,"capacity"][,,"937"]  <- (x["IND",,"PV"][,,"capacity"][,,"937"]  + 1000 * 110 )
  x["JPN",,"IND"][,,"capacity"][,,"979"]  <- (x["IND",,"PV"][,,"capacity"][,,"979"]  + 1000 * 259 )
  x["JPN",,"IND"][,,"capacity"][,,"1020"] <- (x["IND",,"PV"][,,"capacity"][,,"1020"] + 1000 * 103 )
  x["JPN",,"IND"][,,"capacity"][,,"1062"] <- (x["IND",,"PV"][,,"capacity"][,,"1062"] + 1000 * 306 )
  x["JPN",,"IND"][,,"capacity"][,,"1104"] <- (x["IND",,"PV"][,,"capacity"][,,"1104"] + 1000 * 63  )
  x["JPN",,"IND"][,,"capacity"][,,"1145"] <- (x["IND",,"PV"][,,"capacity"][,,"1145"] + 1000 * 31  )

  # adding respective area increases for rooftop PV in IND in the respective bins, using the luse value for IND of 102

  x["JPN",,"IND"][,,"area"][,,"895"]   <- (x["IND",,"PV"][,,"area"][,,"895"]  + 1000 / 102 * 30  )
  x["JPN",,"IND"][,,"area"][,,"937"]   <- (x["IND",,"PV"][,,"area"][,,"937"]  + 1000 / 102 * 110 )
  x["JPN",,"IND"][,,"area"][,,"979"]   <- (x["IND",,"PV"][,,"area"][,,"979"]  + 1000 / 102 * 259 )
  x["JPN",,"IND"][,,"area"][,,"1020"]  <- (x["IND",,"PV"][,,"area"][,,"1020"] + 1000 / 102 * 103 )
  x["JPN",,"IND"][,,"area"][,,"1062"]  <- (x["IND",,"PV"][,,"area"][,,"1062"] + 1000 / 102 * 306 )
  x["JPN",,"IND"][,,"area"][,,"1104"]  <- (x["IND",,"PV"][,,"area"][,,"1104"] + 1000 / 102 * 63  )
  x["JPN",,"IND"][,,"area"][,,"1145"]  <- (x["IND",,"PV"][,,"area"][,,"1145"] + 1000 / 102 * 31  )
