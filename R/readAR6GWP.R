...
#'
#' @return A data.frame with two columns, "Gas", with the common name of the GHG
#' species, and "GWP", with the selected GWP
#'
#' @author Gabriel Abrahao
#'
#' @param subtype data subtype. Currently just "GWP100", but other metrics are
#' also available in the input data
