...
readEDGETransport <- function(subtype = "logit_exponent") {
  ...
  create_copy_demscens <- function(dt) {
    ...
    dt <- rbind(dt,
                ...
                dt[.("gdp_SSP2EU", "gdp_SSP2EU", "Mix1"), nomatch=NULL][
                  , DEM_scenario := "gdp_SSP2EU_NAV_tec"],
                dt[.("gdp_SSP2EU", "gdp_SSP2EU", "Mix2"), nomatch=NULL][
                  , DEM_scenario := "gdp_SSP2EU_NAV_tec"],
                dt[.("gdp_SSP2EU", "gdp_SSP2EU", "NAV_tec"), nomatch=NULL][
                  , DEM_scenario := "gdp_SSP2EU_NAV_tec"],
                dt[.("gdp_SSP2EU_demRedStrong", "gdp_SSP2EU", "Mix1"), nomatch=NULL][
                  , DEM_scenario := "gdp_SSP2EU_NAV_act"],
                dt[.("gdp_SSP2EU_demRedStrong", "gdp_SSP2EU", "Mix2"), nomatch=NULL][
                  , DEM_scenario := "gdp_SSP2EU_NAV_act"],
                ...
                dt[.("gdp_SSP2EU_demRedStrong", "gdp_SSP2EU", "NAV_lce"), nomatch=NULL][
                  , DEM_scenario := "gdp_SSP2EU_NAV_lce"],
                dt[.("gdp_SSP2EU_demRedLow", "gdp_SSP2EU", "CAMP_lscLow"), nomatch=NULL][
                  , DEM_scenario := "gdp_SSP2EU_CAMP_low"],
                ...
                dt[.("gdp_SSP2EU_demRedLow", "gdp_SSP2EU", "CAMP_lscLow_noBan"), nomatch=NULL][
                  , DEM_scenario := "gdp_SSP2EU_CAMP_low"],
                dt[.("gdp_SSP2EU_demRedWeak", "gdp_SSP2EU", "CAMP_lscWeak_noBan"), nomatch=NULL][
                  , DEM_scenario := "gdp_SSP2EU_CAMP_weak"],
                dt[.("gdp_SSP2EU_demRedWeak", "gdp_SSP2EU", "CAMP_lscWeak_noBan"), nomatch=NULL][
                  , DEM_scenario := "gdp_SSP2EU_CAMP_weak"],
                dt[.("gdp_SSP2EU_demRedStrong", "gdp_SSP2EU", "CAMP_lscStrong_noBan"), nomatch=NULL][
                  , DEM_scenario := "gdp_SSP2EU_CAMP_strong"],
                dt[.("gdp_SSP2EU", "gdp_SSP2EU", "Mix2_ban"), nomatch=NULL][
                  , DEM_scenario := "gdp_SSP2EU"],
                dt[.("gdp_SSP2EU", "gdp_SSP2EU", "Mix1"), nomatch=NULL][
