        ...
        'Transport' = { list(
          ...
          rows = tibble(
            name = { c(
              ...
              NA,
              'Energy consumption|Passenger transport (kgoe / 000 pkm)',
              'Energy consumption|Passenger transport|Road transport (kgoe / 000 pkm)',
              'Energy consumption|Passenger transport|Road transport|Powered 2-wheelers (kgoe / 000 pkm)',
              'Energy consumption|Passenger transport|Road transport|Passenger cars (kgoe / 000 pkm)',
              'Energy consumption|Passenger transport|Road transport|Motor coaches, buses and trolley buses (kgoe / 000 pkm)',
              'Energy consumption|Passenger transport|Rail, metro and tram (kgoe / 000 pkm)',
              'Energy consumption|Passenger transport|Rail, metro and tram|Metro and tram, urban light rail (kgoe / 000 pkm)',
              'Energy consumption|Passenger transport|Rail, metro and tram|Conventional passenger trains (kgoe / 000 pkm)',
              'Energy consumption|Passenger transport|Rail, metro and tram|High speed passenger trains (kgoe / 000 pkm)',
              'Energy consumption|Passenger transport|Aviation (kgoe / 000 pkm)',
              'Energy consumption|Passenger transport|Aviation|Domestic (kgoe / 000 pkm)',
              'Energy consumption|Passenger transport|Aviation|International - Intra-EU (kgoe / 000 pkm)',
              'Energy consumption|Passenger transport|Aviation|International - Extra-EU (kgoe / 000 pkm)',
              'Energy consumption|Freight transport (kgoe / 000 tkm)',
              'Energy consumption|Freight transport|Road transport (kgoe / 000 tkm)',
              'Energy consumption|Freight transport|Road transport|Light duty vehicles (kgoe / 000 tkm)',
              'Energy consumption|Freight transport|Road transport|Heavy duty vehicles (kgoe / 000 tkm)',
              'Energy consumption|Freight transport|Rail transport (kgoe / 000 tkm)',
              'Energy consumption|Freight transport|Aviation (kgoe / 000 tkm)',
              'Energy consumption|Freight transport|Aviation|Domestic and International - Intra-EU (kgoe / 000 tkm)',
              'Energy consumption|Freight transport|Aviation|International - Extra-EU (kgoe / 000 tkm)',
              'Energy consumption|Freight transport|Coastal shipping and inland waterways (kgoe / 000 tkm)',
              'Energy consumption|Freight transport|Coastal shipping and inland waterways|Domestic coastal shipping (kgoe / 000 tkm)',
              'Energy consumption|Freight transport|Coastal shipping and inland waterways|Inland waterways (kgoe / 000 tkm)',
        ...
        'TrRail_emi' = { list(
          ...
          rows = tibble(
            name = { c(
              NA,
              'by fuel (kt CO2)',
              'by fuel|Diesel (kt CO2)',
              'by fuel|Electricity (kt CO2)',
              
              'Split of CO2 emissions (kt CO2)',
              'Split of CO2 emissions|Passenger transport (kt CO2)',
              'Split of CO2 emissions|Passenger transport|Metro and tram, urban light rail (kt CO2)',
              'Split of CO2 emissions|Passenger transport|Conventional passenger trains (kt CO2)',
              'Split of CO2 emissions|Passenger transport|Conventional passenger trains|Diesel oil (kt CO2)',
              'Split of CO2 emissions|Passenger transport|Conventional passenger trains|Electric (kt CO2)',
              'Split of CO2 emissions|Passenger transport|High speed passenger trains (kt CO2)',
              'Split of CO2 emissions|Freight transport (kt CO2)',
              'Split of CO2 emissions|Freight transport|Diesel oil (kt CO2)',
              'Split of CO2 emissions|Freight transport|Electric (kt CO2)',
        ...
        'TrRoad_emi' = { list(
          ...
          rows = tibble(
            name = { c(
              ...
              'by fuel|Liquids|Liquified petroleum gas (LPG) (kt CO2)',
              'by fuel|Liquids|Gasoline (without biofuels) (kt CO2)',
              'by fuel|Liquids|Gas/Diesel oil (without biofuels) (kt CO2)',
              'by fuel|Natural gas (kt CO2)',
              'by fuel|Renewable energies and wastes (kt CO2)',
              'by fuel|Renewable energies and wastes|Biogas (kt CO2)',
              'by fuel|Renewable energies and wastes|Biogasoline (kt CO2)',
              'by fuel|Renewable energies and wastes|Biodiesel (kt CO2)',
              'by fuel|Renewable energies and wastes|Other biofuels (kt CO2)',
              'by fuel|Electricity (kt CO2)',
              
              'Split of CO2 emissions (kt CO2)',
              'Split of CO2 emissions|Passenger transport (kt CO2)',
              'Split of CO2 emissions|Passenger transport|Powered 2-wheelers (kt CO2)',
              'Split of CO2 emissions|Passenger transport|Passenger cars (kt CO2)',
              'Split of CO2 emissions|Passenger transport|Passenger cars|Gasoline engine (kt CO2)',
              'Split of CO2 emissions|Passenger transport|Passenger cars|Diesel oil engine (kt CO2)',
              'Split of CO2 emissions|Passenger transport|Passenger cars|LPG engine (kt CO2)',
              'Split of CO2 emissions|Passenger transport|Passenger cars|Natural gas engine (kt CO2)',
              'Split of CO2 emissions|Passenger transport|Passenger cars|Plug-in hybrid electric (kt CO2)',
              'Split of CO2 emissions|Passenger transport|Passenger cars|Battery electric vehicles (kt CO2)',
              'Split of CO2 emissions|Passenger transport|Motor coaches, buses and trolley buses (kt CO2)',
              'Split of CO2 emissions|Passenger transport|Motor coaches, buses and trolley buses|Gasoline engine (kt CO2)',
              'Split of CO2 emissions|Passenger transport|Motor coaches, buses and trolley buses|Diesel oil engine (kt CO2)',
              'Split of CO2 emissions|Passenger transport|Motor coaches, buses and trolley buses|LPG engine (kt CO2)',
              'Split of CO2 emissions|Passenger transport|Motor coaches, buses and trolley buses|Natural gas engine (kt CO2)',
              'Split of CO2 emissions|Passenger transport|Motor coaches, buses and trolley buses|Battery electric vehicles (kt CO2)',
              'Split of CO2 emissions|Freight transport (kt CO2)',
              'Split of CO2 emissions|Freight transport|Light duty vehicles (kt CO2)',
              'Split of CO2 emissions|Freight transport|Light duty vehicles|Gasoline engine (kt CO2)',
              'Split of CO2 emissions|Freight transport|Light duty vehicles|Diesel oil engine (kt CO2)',
              'Split of CO2 emissions|Freight transport|Light duty vehicles|LPG engine (kt CO2)',
              'Split of CO2 emissions|Freight transport|Light duty vehicles|Natural gas engine (kt CO2)',
              'Split of CO2 emissions|Freight transport|Light duty vehicles|Battery electric vehicles (kt CO2)',
              'Split of CO2 emissions|Freight transport|Heavy duty vehicles (kt CO2)',
              'Split of CO2 emissions|Freight transport|Heavy duty vehicles|Domestic (kt CO2)',
              'Split of CO2 emissions|Freight transport|Heavy duty vehicles|International (kt CO2)',
      ...
      sheets = list(
        ...
        'MBunk_emi' = { list(
          ...
          rows = tibble(
            name = { c(
              NA,
              'CO2 emissions|by fuel (kt CO2)',
              'CO2 emissions|by fuel|Liquids (kt CO2)',
              
              'Split of CO2 emissions (kt CO2)',
              'Split of CO2 emissions|Intra-EU (kt CO2)',
              'Split of CO2 emissions|Extra-EU (kt CO2)',
