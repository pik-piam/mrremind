...
convertEDGE <- function(x, subtype = "FE_stationary") {
  ...
  addSSPnames <- function(x) {
    do.call("mbind", lapply(c(paste0("SSP", c(1:5, "2EU", "2_lowEn")),
                              ...
                              paste0("SSP2EU_CAMP_", c("weak", "strong", paste0("strong_", c("temperature", "renovation", "floorspace", "hotwater", "ecomode", "all"))))),
      ...
      scens <- list(
        gdp_SSP2EU = paste0("gdp_SSP2EU_",
                            c("NAV_act", "NAV_ele", "NAV_tec", "NAV_lce", "NAV_all",
                              "CAMP_weak", "CAMP_strong", paste0("CAMP_strong_", c("temperature", "renovation", "floorspace", "hotwater", "ecomode", "all")))),
