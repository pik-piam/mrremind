...
readGCPT <- function(subtype) {
  ...
  # cap2015_add <- additions %>% select(Country,`2016`:`2020`)
  # cap2015_add <- mutate(cap2015_add,post_2015_add=`2016`+`2017`+`2018`+`2019`+`2020`)
  ...
  # 
  # cap2015_ret <- retirements %>% select(Country,`2016`:`2020`)
  # cap2015_ret <- mutate(cap2015_ret,post_2015_ret=`2016`+`2017`+`2018`+`2019`+`2020`)
  ...
  # 
  # #2010 Capacity
  # cap2010_add <- additions %>% select(Country,`2011`:`2020`)
  # cap2010_add <- mutate(cap2010_add,post_2010_add=rowSums(cap2010_add[,2:ncol(cap2010_add)]))
  ...
  # 
  # cap2010_ret <- retirements %>% select(Country,`2011`:`2020`)
  # cap2010_ret <- mutate(cap2010_ret,post_2010_ret=rowSums(cap2010_ret[,2:ncol(cap2010_ret)]))
  ...
  # 
  # #2005 Capacity
  # cap2005_add <- additions %>% select(Country,`2006`:`2020`)
  # cap2005_add <- mutate(cap2005_add,post_2005_add=rowSums(cap2005_add[,2:ncol(cap2005_add)]))
  ...
  # 
  # cap2005_ret <- retirements %>% select(Country,`2006`:`2020`)
  # cap2005_ret <- mutate(cap2005_ret,post_2005_ret=rowSums(cap2005_ret[,2:ncol(cap2005_ret)]))
  ...
  # 
  # #2000 Capacity
  # cap2000_add <- additions %>% select(Country,`2001`:`2020`)
  # cap2000_add <- mutate(cap2000_add,post_2000_add=rowSums(cap2000_add[,2:ncol(cap2000_add)]))
  ...
  # 
  # cap2000_ret <- retirements %>% select(Country,`2001`:`2020`)
  # cap2000_ret <- mutate(cap2000_ret,post_2000_ret=rowSums(cap2000_ret[,2:ncol(cap2000_ret)]))
