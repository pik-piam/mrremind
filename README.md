...
R package **mrremind**, version **0.14.0**
...
Feldhaus L, Brecha R, Rauner S, Dietrich J, Bi S (2020). _mrremind: MadRat REMIND Input Data
Package_. R package version 0.14.0.
