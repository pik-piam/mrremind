...
R package **mrremind**, version **0.39.0**
...
Feldhaus L, Brecha R, Rauner S, Dietrich J, Bi S (2021). _mrremind: MadRat REMIND Input Data
Package_. R package version 0.39.0.
